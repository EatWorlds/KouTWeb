...
import com.cutout.server.controller.pay.alipay.AbstractAliPayApiController;
...
public class AliPayInterceptor implements HandlerInterceptor {
    ...
    private Logger logger = LoggerFactory.getLogger(AliPayInterceptor.class);
    @Override
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object handler) {
        logger.info("preHandle" + HandlerMethod.class.equals(handler.getClass()));
